...
@section('aimeos_slide')
    <div class="shop-banner banner-adv line-scale zoom-image">
        <a href="#" class="adv-thumb-link"><img src="/packages/assets/images/producteur.png" alt="" /></a>
        <div class="banner-info">
            <h2 class="title30 color">Gestion du compte</h2>
            <div class="bread-crumb white"><a href="#" class="white">Accueil</a><span>Compte Agriculteur</span></div>
        </div>
    </div>
@stop
