...
namespace Aimeos\Client\Html\Account\AccountList;

class Standard
    extends \Aimeos\Client\Html\Common\Client\Factory\Base
    implements \Aimeos\Client\Html\Common\Client\Factory\Iface
{
    private $subPartPath = 'client/html/account/accountlist/standard/subparts';
    ...
    public function getBody( $uid = '' )
    {
        ...
        $confkey = 'client/html/account/accountlist';

        if( ( $html = $this->getCached( 'body',$this->catid ?? $uid, $prefixes, $confkey ) ) === null )
        {
            $view = $this->getView();

            $tplconf = 'client/html/account/accountlist/standard/template-body';
            $default = 'account/accountlist/body-standard.php';
            ...
            try
            {
                ...
                $view->accountlistsideBody = $output;
            ...
            catch( \Aimeos\Client\Html\Exception $e )
            {
                ...
                $view->accountlistErrorList = $view->get( 'accountlistErrorList', [] ) + $error;
            }
    ...
    public function getHeader( $uid = '' )
    {
        ...
        {
            $view = $this->getView();
            $tplconf = 'client/html/account/accountlist/standard/template-header';
    ...
    {
        return $this->createSubClient( 'account/accountlist/' . $type, $name );
    }
    ...
    public function modifyBody( $content, $uid )
    {
        ...
        return $this->replaceSection( $content, $this->getView()->csrf()->formfield(), 'account.accountlist.csrf' );
    }
